...
object OffsetDB {
  ...
  object DbOffsetInfo {
    def parse(in: (Option[Int], String, String, String, Long, Long, Option[String], Long, Time, Time)): DbOffsetInfo = {
    ...
    def unparse(in: DbOffsetInfo): Option[(Option[Int], String, String, String, Long, Long, Option[String], Long, Time, Time)] = Some(
      in.id,
      in.offset.group,
      in.offset.topic,
      in.offset.partition,
